...
EndHTML;
  ...
  function process() {
    ...
    header("refresh:1; url={$TMPL['list_url']}/index.php?a=admin&b=manage_pages");	
  }
  ...
  function do_delete($id) {
    ...
    $DB->query("DELETE FROM {$CONF['sql_prefix']}_menu WHERE path = '{$CONF['list_url']}/{$TMPL['url_helper_a']}page{$TMPL['url_helper_id']}{$id}{$TMPL['url_tail']}'", __FILE__, __LINE__);
  }
}
