...
<input type="submit" name="submit" value="{$LNG['a_backup_header']}" class="positive" />
</form>
EndHTML;
    }
    else {
      $tables_to_backup = array(
        ...
        "{$CONF['sql_prefix']}_join_fields" => true,
        ...
        "{$CONF['sql_prefix']}_langs" => true
      );

      eval (PluginManager::getPluginManager ()->pluginHooks ('admin_backup_database'));
